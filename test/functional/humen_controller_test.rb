...
class HumenControllerTest < ActionController::TestCase
  ...
  test "should create human" do
    assert_difference('Human.count') do
      post :create, human: { birthdate: @human.birthdate, last_name: @human.last_name, name: @human.name, sex: @human.sex, total_daughters: @human.total_daughters, total_sons: @human.total_sons }
    end
  ...
  test "should update human" do
    put :update, id: @human, human: { birthdate: @human.birthdate, last_name: @human.last_name, name: @human.name, sex: @human.sex, total_daughters: @human.total_daughters, total_sons: @human.total_sons }
    assert_redirected_to human_path(assigns(:human))
  end
